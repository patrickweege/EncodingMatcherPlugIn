...
public class EncodingMatcherUtil {

	/**
	 * Check whether two charset strings really mean the same thing. For UTF-8,
	 * acceptable variants are utf-8, utf8. For Shift_JIS, acceptable variants
	 * are shift-jis, Shift-JIS, shift_jis.
	 * 
	 * @param a
	 *            The first charset string.
	 * @param b
	 *            The second charset string.
	 * @return true/false
	 */
	 ...
	 * 
	 * @param in
	 *            The input stream, should close the stream before return.
	 * @return the detected charsets or null.
	 */
	public static CharsetMatch[] detectCharsets(InputStream in) {
		if (in != null) {
			try {
				// CharsetDetector.setText() requires that markSupported() ==
				// true.
	...
	public static int getConfidence(CharsetMatch[] charset_match_list, String charset) {
		if (charset_match_list == null || charset == null)
			return 0;
